package com.illusionFactory.lego
{
   ...
   public class ProjectShell extends MovieClip
   {
      ...
      private var __owner:StateGallery;
      
      public function ProjectShell(param1:String, param2:String, param3:String, param4:StateGallery)
      {
         super();
         __sTitle = param1;
         __sThumb = param2;
