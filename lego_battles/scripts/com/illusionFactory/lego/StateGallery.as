package com.illusionFactory.lego
{
   ...
   public class StateGallery extends StateAbstract
   {
      ...
      private var currentShell:ProjectShell;
      ...
      public function StateGallery()
      {
         pageCounter = 0;
         thumbInc = 324;
         super();
         _name = "StateGallery";
         _view = new ViewGallery();
         loadLarge = new Loader();
      }
      ...
      private function mcDownClicked(param1:MouseEvent) : void
      {
         if(largeInc + 1 < aShells.length)
         {
            ++largeInc;
            aShells[largeInc].dispatchEvent(new MouseEvent(MouseEvent.CLICK));
            if(largeInc >= SHELLS_ON_PAGE && largeInc % SHELLS_ON_PAGE == 0)
            {
      ...
      private function loadXML() : void
      {
         ...
         var _loc9_:ProjectShell = null;
         var _loc10_:GalleryBorder = null;
         var _loc11_:uint = 0;
         _loc1_ = 0;
         _loc2_ = 0;
         xmlData = _app.getXMLData("gallery");
         aShells = new Array();
         _loc3_ = new Array();
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            _loc9_ = new ProjectShell(_loc8_,_loc6_,_loc7_,this);
            aShells.push(_loc9_);
         ...
         _view.mcDown.addEventListener(MouseEvent.CLICK,mcDownClicked);
         largeInc = 0;
      ...
      public function doLoadLargeImage(param1:ProjectShell) : void
      {
         if(currentShell)
         {
            currentShell.enable();
         ...
         currentShell = param1;
         largeInc = getShellIndex(currentShell);
      ...
      private function getShellIndex(param1:ProjectShell) : uint
      {
         var _loc2_:uint = 0;
